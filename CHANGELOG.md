...
* **docs:** Build API docs after demo project ([dec2d0f](https://github.com/Airblader/ngqp/commit/dec2d0f))



<a name="0.4.1"></a>
## [0.4.1](https://github.com/Airblader/ngqp/compare/v0.4.0...v0.4.1) (2018-12-30)


### Bug Fixes

* **docs:** chmod +x script ([21e44c1](https://github.com/Airblader/ngqp/commit/21e44c1))
